...
public interface BiddingFileService extends BaseService<BiddingFileEntity, Integer> {
     ...
     */
    void add(BiddingFileEntity biddingFileEntity, Long[] auditorIds, Integer[] sorts, String trueName);
     ...
     * @param trueName          当前登录用户真实姓名
     */
    void edit(BiddingFileEntity biddingFileEntity, Long[] auditorIds, Integer[] sorts, String trueName);
