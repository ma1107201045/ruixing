...
import com.yintu.ruixing.danganguanli.LineTechnologyStatusStationUnitDao;
...
public class LineTechnologyStatusStationUnitServiceImpl implements LineTechnologyStatusStationUnitService {
    ...
    @Override
    public List<LineTechnologyStatusStationUnitEntity> findAll() {
        return lineTechnologyStatusStationUnitDao.selectAll();
    }
}
