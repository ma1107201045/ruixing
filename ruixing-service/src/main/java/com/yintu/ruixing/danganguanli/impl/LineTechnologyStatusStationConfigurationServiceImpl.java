...
import com.yintu.ruixing.master.danganguanli.LineTechnologyStatusStationConfigurationDao;
...
public class LineTechnologyStatusStationConfigurationServiceImpl implements LineTechnologyStatusStationConfigurationService {
    ...
    @Override
    public List<LineTechnologyStatusStationConfigurationEntity> findByExample(Integer stationId) {
        return lineTechnologyStatusStationConfigurationDao.selectByExample(stationId);
    }
